...
@implementation C_Education_SchoolVC
...
-(IBAction)btnDoneClicked:(id)sender
{
    ...
    {
        [CommonMethods displayAlertwithTitle:[NSString stringWithFormat:@"Please Enter your school name"] withMessage:nil withViewController:self];
    }
    else
    {
